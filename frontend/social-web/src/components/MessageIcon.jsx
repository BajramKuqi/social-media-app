...
function MessageIcon() {
    ...
    return (
        <Link to="/messages" className="relative p-2 rounded-full hover:bg-mint-100 transition-colors" aria-label="Messages">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-ink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
